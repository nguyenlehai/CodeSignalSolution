...
Because there is a tie, the smallest x between x = 2 and x = 3 is the answer.
  ...
  public int absoluteValuesSumMinimization(int[] a) {
	...
	return arrayIndex.get(arrayAns.indexOf(Collections.min(arrayAns)));
  }


  public static void main(String[] args) {
	int[] absoluteValuesSumMinimization = {2, 4};

	ThroughTheFog throughTheFog = new ThroughTheFog();
	throughTheFog.absoluteValuesSumMinimization(absoluteValuesSumMinimization);
  }
}
